...
SVTB1= ../tb/top.sv
INC = +incdir+../tb +incdir+../test +incdir+../slave +incdir+../master
...
run_test15 : run_test15_$(SIMULATOR)		
...
view_wave16 : view_wave16_$(SIMULATOR)		
...
sv_cmp_VCS:
	vcs -l vcs.log -timescale=1ns/1ps -cm line+tgl+fsm+branch+cond -sverilog -ntb_opts uvm -debug_access+all -full64 -kdb  -lca -P $(FSDB_PATH)/novas.tab $(FSDB_PATH)/pli.a $(RTL) $(INC) $(SVTB2) $(SVTB1) 		      
...
run_test1_VCS:	clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave2.fsdb -cm_dir ./mem_cov2 +ntb_random_seed_automatic +UVM_TESTNAME=single_trans_test 
	urg -dir mem_cov2.vdb -format both -report urgReport2
	
run_test2_VCS:	clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave3.fsdb -cm_dir ./mem_cov3 +ntb_random_seed_automatic +UVM_TESTNAME=incr_trans_test
	urg -dir mem_cov3.vdb -format both -report urgReport3
	
run_test3_VCS:	clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave4.fsdb -cm_dir ./mem_cov4 +ntb_random_seed_automatic +UVM_TESTNAME=wrap_trans_test
...
report_VCS:
	urg -dir mem_cov1.vdb mem_cov2.vdb mem_cov3.vdb mem_cov4.vdb mem_cov5.vdb mem_cov6.vdb mem_cov7.vdb mem_cov8.vdb mem_cov9.vdb mem_cov10.vdb -dbname merged_dir/merged_test -format both -report urgReport
